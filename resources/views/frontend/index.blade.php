                ...
                <div class="row align-items__center">
                    ...
                    <div class="col-lg-6 col-sm-5 col-xs-12 col-md-5">
                        <div class="slide__thumb">
                            <img src="images/slider/fornt-img/sofa-1.webp" alt="slider images">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="single__slide animation__style01 slider__fixed--height">
            <div class="container">
                <div class="row align-items__center">
                    ...
                    <div class="col-lg-6 col-sm-5 col-xs-12 col-md-5">
                        <div class="slide__thumb">
                            <img src="images/slider/fornt-img/chair-1.webp" alt="slider images">
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-md-4 col-lg-3 col-sm-4 col-xs-12">
                                <div class="category">
                                    <div class="ht__cat__thumb">
                                        <a href="{{ url('p_detail/' . $lists->id) }}">
                                            <img src="{{ asset('upload/' . $lists->image) }}" width="260"
                                                height="350" alt="{{ $lists->name }}">
                                        </a>
                                    </div>
                                    <div class="fr__hover__info">
                                        <ul class="product__action">
                                            <li><a href="wishlist.html"><i class="icon-heart icons"></i></a></li>
                                            <li><a href="{{ url('add_cart/' . $lists->id) }}"><i                                         class="icon-handbag icons"></i></a></li>
                                            <li><a href="#"><i class="icon-shuffle icons"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="fr__product__inner">
                                    <h4><a href="product-details.html">{{ $lists->name }}</a></h4>
                                    <ul class="fr__pro__prize">
                                        <li class="old__prize">{{ '₹' . $lists->mrp }}</li>
                                        <li>{{ '₹' . $lists->price }}</li>
                                    </ul>
                                </div>
                            </div>
